...
> 3.5mmストロークのスイッチを使用する場合は、専用の `main.c` を使用するか、プログラム内の `TRAVEL_DISTANCE_MM` を `3.5f` に変更してビルドしてください。
...
本プロジェクトのコードおよびドキュメントは、主に Gemini および Google AI Studio を利用して作成されました。
細かいところ聞かないでクレメンス
